...
class CFGmsk:
    ...
    def cetakTrans(self):
        hslstr=[]
        hslstr.append(" ".join(self.grammer))
        hslstr.append(" ".join(self.simbol))
        for i in self.trans:
            hslstr.append("{} -> {}".format(i," | ".join([" ".join(z) for z in self.trans[i]])))
        hslstr.append(self.final)     
        return hslstr
    ...
    def checkstring(self,string):
        ...
        translate.append(util.tranlateToTable(martix=martixs))
